...
Engineering management and program leadership

## Purpose

Communicate status, limitations, next steps, and operational risk.
...
flowchart LR
    ...
    C --> D[Management Report]
```

## Public Example

A portfolio PDF rendering is available in [pdf/MANAGEMENT_REPORT.pdf](pdf/MANAGEMENT_REPORT.pdf).
